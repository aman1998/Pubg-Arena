  ...
  return (
    <PageTemplate>
      <section className='privacy container'>
        ...
        <p>Правила обязательны для исполнения всеми участниками и командами участников, принимающими участие в каком-либо Турнире на стриминговой киберспортивной платформе Arena (далее — Платформа Arena). Регистрация на Турнир означает ваше полное и безоговорочное согласие с настоящими правилами.</p>
        ...
        <div className='privacy-list'>
          ...
          <div>3.1. Чтобы принять участие в Турнире, необходимо пройти регистрацию на Турнир на Платформе Arena, для чего необходимо выбрать интересующий вас Турнир в разделе Турниров и нажать кнопку регистрации. В случае если участие в Турнире осуществляется за билеты, необходимо приобрести нужное количество билетов и оплатить ими участие в Турнире.
          </div>
        ...
        <div className='privacy-list'>
          ...
          <div>8.2. К нарушениям относятся:
            <ul>
              <li>оскорбление других участников, зрителей, судей, комментаторов или организаторов Турнира;</li>
              ...
              <li>участие в каких-либо Турнирах с помощью ботов, программ, читов, или аналогичных методов, использование эмулятора на десктопе, позволяющего играть в мобильную игру на десктопном устройстве, либо совершение иного рода мошеннических действий в отношении Платформы Arena (все вместе - читерское ПО). Любая попытка сделать это приведет к прекращению вашего доступа к вашей учетной записи, а также к призам и билетам. Организатор Турнира оставляет за собой право прекратить доступ к любой учетной записи, владелец которой подозревается в подделке результатов своей игры для участия в Турнире или иным образом нарушил настоящие правила;
...
нарушать Условия использования платформы “Arena”.</li>
            </ul>
          </div>
        </div>
        <div className='privacy-list'>
        ...
        <div className='privacy-list'>
          ...
          <div>10.2. Результаты и победители каждого Турнира определяются Платформой Arena автоматически с учетом фактических данных игры.</div>
