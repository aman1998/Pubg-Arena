  ...
  return (
    <PageTemplate>
      <section className='support container'>
        ...
        <a className='support-link' href='https://www.instagram.com/arenagames.io/' target='_blank' rel="noreferrer">
          <div className='item'>
        ...
        <a className='support-link' href='https://t.me/arenagamesio' target='_blank' rel="noreferrer">
          <div className='item'>
